    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('blur', function(e) {
            ...
            if (field.value.trim()) {
                if (field.type === 'email' && !validateEmail(field.value.trim())) {
                    showError(field, 'Please enter a valid email address');
                } else if (field.type === 'tel' && !validatePhone(field.value.trim())) {
                    showError(field, 'Please enter a valid phone number');
                } else {
                    clearError(field);
                }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0db51c59-8dea-461a-8f2b-15fb32cb28b3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0db51c59-8dea-461a-8f2b-15fb32cb28b3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0db51c59-8dea-461a-8f2b-15fb32cb28b3';
